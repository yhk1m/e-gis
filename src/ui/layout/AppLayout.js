          ...
          <div class="menu-items">
            ...
            <div class="menu-item dropdown" data-menu="about">
              ...
              <div class="dropdown-menu" id="menu-about">
                ...
                <a href="https://github.com/yhk1m/e-gis/releases/latest" class="dropdown-item dropdown-link" target="_blank" rel="noopener" title="e-GIStory(이지스토리) 데스크톱 앱 다운로드 — GitHub Releases">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
