/**
 * PrivacyPolicyPanel - 개인정보처리방침 패널
 * 개인정보처리방침 전문 표시 및 동의 관리
 */

// PDF는 public 폴더의 정적 파일을 다운로드
...
export const PRIVACY_POLICY_CONTENT = {
  title: '개인정보 처리방침',
  lastUpdated: '2026년 8월 15일',
  effectiveDate: '2026년 2월 7일',

  intro: `e-GIS(이하 "서비스")는 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 다음과 같이 개인정보 처리방침을 수립·공개합니다.`,

  sections: [
    {
      title: '제1조 개인정보의 처리목적',
      content: `① 서비스는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하는 개인정보는 다음 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받습니다.
...
학교별 이용 통계 분석, 서비스 품질 향상, 신규 서비스 개발을 위한 자료 등의 목적으로 개인정보를 처리합니다.`
    },
    {
      title: '제2조 처리하는 개인정보 항목',
      content: `① 서비스는 「개인정보 보호법」에 따라 서비스 제공을 위해 필요 최소한의 범위에서 다음의 개인정보 항목을 수집·이용합니다.
...
② 이용자는 서비스 이용을 위한 개인정보 수집에 대하여 거부할 수 있습니다. 다만, 필수항목은 서비스 이용에 필요한 최소한의 정보이므로 이에 대한 수집 거부 시 회원가입이 제한됩니다.`
    },
    {
      title: '제3조 개인정보의 처리 및 보유기간',
      content: `① 서비스는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보 수집 시에 동의받은 보유·이용기간 내에서 개인정보를 처리·보유합니다.
...
• 로컬 데이터: 브라우저 저장소(IndexedDB, LocalStorage) 초기화를 통한 삭제`
    },
    {
      title: '제5조 만 14세 미만 아동의 개인정보 보호',
      content: `① 서비스는 만 14세 미만 아동의 개인정보를 처리하기 위하여 동의가 필요한 경우에는 해당 아동의 법정대리인으로부터 동의를 받습니다.

② 서비스는 회원가입 화면에서 이용자가 만 14세 이상인지를 확인합니다. 만 14세 미만인 경우에는 법정대리인의 동의를 받았음을 확인한 경우에만 가입이 진행되며, 확인 결과(만 14세 이상 여부, 법정대리인 동의 여부, 동의 확인 방법)는 가입 시점에 회원 정보와 함께 기록·보관됩니다.
...
④ 법정대리인은 만 14세 미만 아동의 개인정보에 대하여 열람, 정정·삭제, 처리정지 요구 등의 권리를 아동을 대신하여 행사할 수 있습니다.`
    },
    {
      title: '제6조 개인정보의 제3자 제공',
      content: `① 서비스는 정보주체의 개인정보를 개인정보의 처리 목적에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공하고 그 이외에는 정보주체의 개인정보를 제3자에게 제공하지 않습니다.`
    },
    {
      title: '제7조 개인정보처리의 위탁',
      content: `① 서비스는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.

<strong>1. Supabase, Inc.</strong>
• 위탁하는 업무 내용: 사용자 인증 및 클라우드 데이터베이스 운영·관리
• 이전되는 항목: 이메일 주소, 프로필(이름·닉네임·소속 학교·지역), 저장한 프로젝트 데이터
• 이전 국가: 미국 (서버 소재지)
• 이전 시기 및 방법: 서비스 이용 시점에 네트워크를 통한 전송
• 개인정보 보유 및 이용기간: 회원 탈퇴 시 또는 위탁계약 종료 시까지

<strong>2. Google LLC (Google Apps Script)</strong>
• 위탁하는 업무 내용: 방문자 수 집계
• 이전되는 항목: 접속 시 발생하는 IP 주소 등 접속 정보 (이용자를 식별하는 정보는 전송하지 않음)
• 이전 국가: 미국 (서버 소재지)
• 이전 시기 및 방법: 서비스 접속 시점에 네트워크를 통한 전송
• 개인정보 보유 및 이용기간: 집계 목적 달성 시까지

<strong>3. OpenStreetMap Foundation (Nominatim)</strong>
• 위탁하는 업무 내용: 위치 검색(지오코딩) 및 좌표→주소 변환
• 이전되는 항목: 이용자가 입력한 검색어, '현재 위치' 기능 사용 시 해당 좌표, 접속 IP 주소
• 이전 국가: 영국·독일 등 (서버 소재지)
• 이전 시기 및 방법: 위치 검색 기능 사용 시점에 네트워크를 통한 전송
• 개인정보 보유 및 이용기간: 요청 처리 시까지

<strong>4. HeiGIT gGmbH (OpenRouteService)</strong>
• 위탁하는 업무 내용: 최단경로·등시선 분석 연산
• 이전되는 항목: 분석 대상 좌표, 접속 IP 주소
• 이전 국가: 독일 (서버 소재지)
• 이전 시기 및 방법: 경로·등시선 분석 기능 사용 시점에 네트워크를 통한 전송
• 개인정보 보유 및 이용기간: 요청 처리 시까지

※ 위 2~4번은 해당 기능을 사용할 때만 전송이 발생하며, 회원 정보(이메일·이름·소속 학교 등)는 전송되지 않습니다.
...
④ 이용자는 회원 탈퇴를 통해 국외 이전을 거부할 수 있으며, 이 경우 클라우드 저장 서비스 이용이 제한됩니다.`
    },
    {
      title: '제8조 개인정보 자동 수집 장치의 운영 및 거부',
      content: `① 서비스는 이용자의 편의를 위해 브라우저 로컬 저장소(LocalStorage, IndexedDB)를 사용하여 설정값과 프로젝트 데이터를 저장합니다.

② 로컬 저장소에 보관된 설정값과 프로젝트 데이터는 이용자의 기기에만 저장되며, 이용자가 클라우드 저장 기능을 사용하지 않는 한 서버로 전송되지 않습니다. 이용자는 브라우저 설정을 통해 저장된 데이터를 삭제할 수 있습니다.

③ 서비스는 방문자 수 집계를 위해 접속 시 1일 1회 외부 집계 서버(제7조 제2호)에 요청을 보냅니다. 이때 이용자를 식별하는 정보는 전송하지 않으며, 같은 기기의 중복 집계를 막기 위한 방문 일자만 브라우저 로컬 저장소에 기록합니다.
...
• 이메일(fkv777@gmail.com)로 요청 시 지체 없이 조치`
    },
    {
      title: '제10조 개인정보의 안전성 확보 조치',
      content: `① 서비스는 「개인정보 보호법」 제29조에 따라 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.
...
• 전송 구간 암호화: 전 구간 HTTPS 암호화 통신 적용(HTTP 접속은 HTTPS로 자동 전환), TLS 1.3 사용
• 접근 권한 관리: 데이터베이스 행 수준 보안(RLS) 적용으로 이용자는 자신의 데이터에만 접근 가능
• 웹 보안 헤더 적용: Content-Security-Policy(악성 스크립트 삽입 차단), X-Frame-Options(클릭재킹 차단), X-Content-Type-Options, Referrer-Policy, Permissions-Policy
• 이용자가 입력한 이름이 화면에 표시될 때 스크립트로 실행되지 않도록 처리

<strong>물리적 조치</strong>
• 개인정보는 별도의 자체 서버 없이 수탁자(제7조)의 데이터센터에 보관하며, 해당 데이터센터의 물리적 접근통제 조치를 따릅니다.`
    },
    {
      title: '제11조 개인정보 보호 책임자 안내',
...
② 정보주체는 서비스를 이용하면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자에게 문의하실 수 있습니다. 서비스는 정보주체의 문의에 대해 지체 없이 답변 및 처리해 드릴 것입니다.`
    },
    {
      title: '제12조 개인정보 처리방침의 변경',
      content: `① 이 개인정보 처리방침은 2026년 2월 7일부터 적용됩니다.

② 이 개인정보 처리방침은 법령, 정책 또는 보안기술의 변경에 따라 내용이 추가, 삭제 및 수정될 수 있습니다. 변경 시에는 변경사항 시행 7일 전부터 서비스 내 공지사항을 통해 고지할 것입니다.

③ 본 방침은 최초로 수립·공개되는 개인정보 처리방침이므로, 이전의 개인정보 처리방침 이력은 존재하지 않습니다.`
    },
    {
...
※ 행정심판에 대해 자세한 사항은 중앙행정심판위원회(www.simpan.go.kr) 홈페이지를 참고하시기 바랍니다.`
    ...
    {
      title: '제14조 개인정보 열람청구',
      content: `① 정보주체는 「개인정보 보호법」 제35조에 따른 개인정보의 열람 청구를 아래의 담당자에게 할 수 있습니다. 서비스는 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.

▶ 개인정보 열람청구 접수·처리 담당자
• 성명: 김용현
• 직위: 개발자
• 연락처: bgnlkim@gmail.com`
    }
  ]
};
...
class PrivacyPolicyPanel {
  ...
  render() {
    ...
    this.modal.className = 'modal-overlay privacy-modal active';

    this.modal.innerHTML = `
      <div class="modal-content privacy-content">
        <div class="modal-header">
          <h3>${PRIVACY_POLICY_CONTENT.title}</h3>
        ...
        <div class="modal-body privacy-body">
          ...
          <div class="privacy-intro">${PRIVACY_POLICY_CONTENT.intro}</div>
          <div class="privacy-sections">
            ${PRIVACY_POLICY_CONTENT.sections.map(section => `
              <div class="privacy-section">
                <h4>${section.title}</h4>
                <div class="privacy-section-content">${section.content.replace(/\n/g, '<br>')}</div>
              </div>
            `).join('')}
          </div>
        </div>
  ...
  bindEvents() {
    ...
    const downloadBtn = document.getElementById('privacy-download-pdf');
  ...
  downloadPDF() {
    ...
    link.href = `${import.meta.env.BASE_URL}privacy-policy.pdf`;
    link.download = '개인정보 처리방침(e-GIS).pdf';
    link.click();
  }
...
export const privacyPolicyPanel = new PrivacyPolicyPanel();
