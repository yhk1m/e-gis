import{a as p,P as o}from"./PrivacyPolicyPanel-B1luajin.js";function t(){localStorage.getItem("egis-theme")==="dark"&&document.documentElement.setAttribute("data-theme","dark")}function i(){t();const a=document.getElementById("privacy-app");a.innerHTML=`
    <div class="privacy-page">
      ...
      <main class="privacy-page-main">
        <h1 class="privacy-page-heading">${p.title}</h1>
        <div class="privacy-page-meta">
          <span>버전: ${o}</span>
          <span>시행일: ${p.effectiveDate}</span>
          <span>최종 수정: ${p.lastUpdated}</span>
        </div>
        <div class="privacy-page-intro">${p.intro}</div>
        <div class="privacy-page-sections">
          ${p.sections.map(e=>`
            <section class="privacy-page-section">
              <h2>${e.title}</h2>
              <div class="privacy-page-section-content">${e.content.replace(/\n/g,"<br>")}</div>
            </section>
          `).join("")}
        </div>
        <div class="privacy-page-actions">
          <a href="/privacy-policy.pdf" download="개인정보 처리방침(e-GIS).pdf" class="privacy-page-btn privacy-page-btn-primary">
...
`;document.head.appendChild(r);document.addEventListener("DOMContentLoaded",i);
//# sourceMappingURL=privacy-BsWc0TqQ.js.map
